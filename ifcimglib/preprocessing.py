...
__all__ = ['min_max_normalize', 'crop_and_pad_to_square', 'compute_per_pixel_mean']
...
# Cell
def compute_per_pixel_mean(db, shape, do_preprocess_steps=False):
    # according to http://proceedings.mlr.press/v28/wan13.html
    total = numpy.zeros(shape, dtype=numpy.float32)
    n = 0.0
